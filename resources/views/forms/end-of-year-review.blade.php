                            ...
                            <div class="overflow-x-auto">
                                <table class="table-auto w-full bg-white border-collapse border border-gray-300">
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-4 py-2">WEIGHT OF TARGET</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-gray-100"><textarea type="text" class="w-full p-2"
                                                                          name="comments1" required></textarea></td>
                                    </tr>
                                    <tr>
