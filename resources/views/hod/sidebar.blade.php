<div>
    ...
    <!-- Sidebar -->
    <div class="fixed flex flex-col top-14 left-0 bg-white h-full text-gray-600 transition-all duration-300 border-none z-10 sidebar hover:w-64 sm:w-10 md:w-64  md:block ">
