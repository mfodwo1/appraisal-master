...
{{--    HOD comments--}}
    <div class="container mx-auto p-4 my-6 ">
        <div class=" w-full bg-gray-50 transition-all overflow-hidden shadow-xl md:w-[calc(100%-256px)] md:ml-64 sm:rounded-lg max-w-7xl mx-auto sm:px-6 lg:px-8 sm:ms-35" style="background: #edf2f7;">
            <div class="py-5">
                <h2 class="text-2xl font-semibold">SSECTION 10: Head of Department’s / Division’s (HOD) Comments</h2>
                <form>
                    <div class="mb-4">
                        <label for="appraiser-comments" class="block text-base font-medium">Head of Department’s / Division’s (HOD) Comments</label>
                        <textarea class="w-full p-2 border border-gray-300 rounded-lg" id="appraiser-comments" rows="4"></textarea>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="signatureFile2" class="block text-base font-medium">HOD’S SIGNATURE</label><br>
                            ...
                            <button id="removeSignature2" class="btn btn-primary mt-2 hidden">Remove Signature</button><br>
                            <label for="appraiserDate" class="block mt-2 text-right">Date:</label>
                            <input type="date" class="w-full p-2 border border-gray-300 rounded-lg" name="appraiserDate" id="appraiserDate" required>
                        </div>
                    </div>
                    <button type="submit" class="bg-blue-500 text-white rounded-3xl p-2 mb-6">Update Profile</button>
                </form>
