...
<head>
    ...
    <meta name="description" content="appraisal system" />
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #0074E4 0%, #00A4E4 100%);
        }
    </style>
</head>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    @if (Route::has('login'))
                            ...
                            @auth
                                <li class="mr-3">
                                <a href="{{ url('/home') }}" class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4">Dashboard</a>
                                </li>
                            @else
                                <li class="mr-3">
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    Hospital Appraisal System
                </h1>
                <p class="leading-normal text-2xl mb-8">
                    Welcome to the Hospital's Performance Appraisal System
                </p>
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">
                        Welcome to our Hospital's Performance Appraisal System! This platform has been designed to foster a culture of continuous improvement and excellence within our healthcare facility.
                        <br />
                        <br />
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        ...
                        <p class="text-gray-600 mb-8">
                            Our mission is to empower every member of our hospital to set and achieve meaningful goals, and through constructive feedback and evaluation, enhance the quality of patient care, professional growth, and overall satisfaction.
                            <br />
                            <br />
                        </p>
                    </div>
                ...
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Easily set, track, and manage your performance goals for the year.
                        </p>
                    </a>
                </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Access resources and training opportunities to support your career growth.
                        </p>
                    </a>
                </div>
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Foster open communication and receive constructive feedback to improve performance.
                        </p>
                    </a>
                </div>
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        ...
        <h3 class="my-4 text-3xl leading-tight">
            begin using the system, please login with your credentials. If you are a new user, you can create an account to get started.
        </h3>
        <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            Get Started
        </button>
